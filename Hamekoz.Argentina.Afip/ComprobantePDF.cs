...
namespace Hamekoz.Argentina.Afip
{
    ...
    public class ComprobantePDF
    {
        ...
        public Empresa Emisor
        {
            ...
            /* Cambio no fusionado mediante combinación del proyecto 'Hamekoz.Argentina.Afip(net9.0)'
            Antes:
            ...
            Después:
                    static readonly Font fuente = FontFactory.GetFont (FontFactory.HELVETICA, 9);
                    static readonly Font fuenteTitulo = FontFactory.GetFont (FontFactory.HELVETICA, 9, Font.BOLD);
                    static readonly Font fuenteTotal = FontFactory.GetFont (FontFactory.HELVETICA, 12, Font.BOLD);
                    static readonly Font fuenteBarcodeText = FontFactory.GetFont (FontFactory.HELVETICA, 6);
            */
        }
