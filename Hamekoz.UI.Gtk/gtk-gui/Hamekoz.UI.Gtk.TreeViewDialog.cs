...
namespace Hamekoz.UI.Gtk
{
	public partial class TreeViewDialog
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget Hamekoz.UI.Gtk.TreeViewDialog
			this.Name = "Hamekoz.UI.Gtk.TreeViewDialog";
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			this.Resizable = false;
			this.Decorated = false;
			// Internal child Hamekoz.UI.Gtk.TreeViewDialog.VBox
			...
			w2.Position = 0;
			// Internal child Hamekoz.UI.Gtk.TreeViewDialog.ActionArea
