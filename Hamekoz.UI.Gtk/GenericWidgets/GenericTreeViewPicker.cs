...
namespace Hamekoz.UI.Gtk
{
	public class GenericTreeViewPicker<T> : Bin
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget Hamekoz.UI.Gtk.WidgetTreeViewPicker
			global::Stetic.BinContainer.Attach (this);
			this.Name = "Hamekoz.UI.Gtk.WidgetTreeViewPicker";
			// Container child Hamekoz.UI.Gtk.WidgetTreeViewPicker.Gtk.Container+ContainerChild
